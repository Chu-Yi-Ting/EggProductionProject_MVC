...
public partial class EggPlatformContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.Property(e => e.BmemberSid).HasColumnName("BMemberSid");
        ...
        modelBuilder.Entity<Calendar>(entity =>
        {
            ...
            entity.Property(e => e.TodoList).HasColumnType("text");
        ...
        modelBuilder.Entity<Member>(entity =>
        {
            ...
            entity.HasOne(d => d.AspUser).WithMany(p => p.Members)
                ...
                .HasConstraintName("FK_Member_AspNetUsers");
        ...
        {
            entity.HasKey(e => e.StoreImageSid);

            entity.Property(e => e.ImageDescription).HasMaxLength(255);
            entity.Property(e => e.UploadTime).HasColumnType("datetime");

            entity.HasOne(d => d.StoreS).WithMany(p => p.StoreImages)
                .HasForeignKey(d => d.StoreSid)
