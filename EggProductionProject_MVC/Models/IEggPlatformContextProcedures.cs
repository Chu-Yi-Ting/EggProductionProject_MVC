...
namespace EggProductionProject_MVC.Models
{
    public partial interface IEggPlatformContextProcedures
    {
        ...
        Task<List<GetEventsForMemberResult>> GetEventsForMemberAsync(int? MemberSid, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
