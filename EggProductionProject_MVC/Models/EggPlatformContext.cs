...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=EggPlatform;Encrypt=true;Integrated Security=True;TrustServerCertificate=true");
